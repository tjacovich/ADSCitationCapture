    ...
    def _init_mock_data(self):
        ...
        self.mock_data["10.5281/zenodo.11020"] = {
                ...
                'parsed': {
                    ...
                    'references': [],
                    'description_of': [],
                    'authors': [u'Dan Foreman-Mackey', u'Adrian Price-Whelan', u'Geoffrey Ryan', u'Emily', u'Michael Smith', u'Kyle Barbary', u'David W. Hogg', u'Brendon J. Brewer'],
                    'keywords': [],
                    'forks': [],
                    'properties': {
